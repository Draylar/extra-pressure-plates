...
public class InvisiblePoisonedPressurePlate extends PressurePlateBlock
{
    public InvisiblePoisonedPressurePlate(Type pressurePlateBlock$Type_1, Settings block$Settings_1)
    {

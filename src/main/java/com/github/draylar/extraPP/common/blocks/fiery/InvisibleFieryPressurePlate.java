...
public class InvisibleFieryPressurePlate extends PressurePlateBlock
{
    public InvisibleFieryPressurePlate(Type pressurePlateBlock$Type_1, Settings block$Settings_1)
    {
